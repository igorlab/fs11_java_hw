public class Family0 {
    ...
    public Family0(Human0 mother, Human0 father) {
        this.mother = mother;
        this.father = father;
    ...
    public Family0(Human0 mother, Human0 father, Human0[] children) {
        this.mother = mother;
        this.father = father;
    ...
    public Family0(Human0 mother, Human0 father, Human0[] children, Pet0 pet0) {
        this.mother = mother;
        this.father = father;
        this.children = children;
        this.pet0 = pet0;
