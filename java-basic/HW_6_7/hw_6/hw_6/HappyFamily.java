...
public class HappyFamily {
    public static void main(String[] args) {
        ...
        Pet petOne = new Pet(Species.CAT,"superCat", 3, 100, new String[] {"eat", "drink", "sleep"});
        ...
        System.out.println("is family04 equal to family01? " + family04.equals(family01));
        System.out.println("is petTwo equal to petOne? " + petTwo.equals(petOne));
